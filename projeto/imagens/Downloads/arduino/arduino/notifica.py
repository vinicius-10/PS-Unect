...
#o nome DELKV se refere a pasta que os arquivos estão caso mude troque esse nome
#o link funciona perfeitamente com o xamp serve porem com servidores que não usam o caminho como o link da pagina ele não irar funcionar ex:EasyPHP
corpo_email = f"""
...
msg['From'] = 'valucard10@gmail.com'
msg['To'] = email_usuario 
password = 'uizeszxdknzrlikd' 
